      ...
      <AnimatePresence>
        {visible ? (
          <motion.a
            ...
            className="relative grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-white shadow-[0_10px_28px_-8px_rgba(37,211,102,0.55)] transition-transform duration-200 hover:scale-105 hover:shadow-[0_14px_36px_-8px_rgba(37,211,102,0.7)] md:h-[60px] md:w-[60px]"
          >
            <span
              aria-hidden
              className="pointer-events-none absolute -top-1 -right-1 h-3 w-3 rounded-full bg-white/95"
            >
